# PROJECT 1 - RAG Knowledge Graph RAG for Enterprise Data (RAG) 
Techstack - React js, Python, Neo4j, LangChain, Claude API, pgvector, FastAPI, Docker.  
...
### Resume line:  
Built a hybrid knowledge graph and vector RAG system over N documents; raised multi hop question accuracy from X to Y percent against a vector  baseline at Z ms p95. 
...
### Stretch goals:  
Incremental graph updates instead of full reingestion, community detection for corpus level summaries, and a graph visualization in the response UI.